...
:warning: **This workflow is only meant as an example**: There are several additional steps for data preparation which should be done to really use the data from Neotoma!
...
To speed the process up, we can also set `use_parallel` == `TRUE`, which will use all cores of a computer.
